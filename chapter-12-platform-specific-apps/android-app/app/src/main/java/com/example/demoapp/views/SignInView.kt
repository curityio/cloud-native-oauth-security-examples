...
fun SignInView(onSignIn: () -> Unit) {
    ...
    Column(
        ...
        TextHeading(stringResource(id = R.string.sign_in_heading))
        TextParagraph(stringResource(id = R.string.sign_in_info))
        CustomButton(stringResource(id = R.string.sign_in_command), onSignIn)
    }
}
